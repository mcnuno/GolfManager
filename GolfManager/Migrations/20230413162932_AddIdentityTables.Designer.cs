...
namespace GolfManager.Migrations
{
    ...
    [Migration("20230413162932_AddIdentityTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GolfManager.Model.Club", b =>
                {
            ...
            modelBuilder.Entity("GolfManager.Model.Hole", b =>
                {
                    b.Property<Guid>("Idhole")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("GolfManager.Model.Player", b =>
                {
            ...
            modelBuilder.Entity("GolfManager.Model.PlayersClub", b =>
                {
                    b.Property<Guid>("Idclub")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("IDClub");
            ...
            modelBuilder.Entity("GolfManager.Model.Hole", b =>
                {
                    b.HasOne("GolfManager.Model.Club", "IdclubNavigation")
                        .WithMany("Holes")
            ...
            modelBuilder.Entity("GolfManager.Model.PlayersClub", b =>
                {
                    ...
                    b.HasOne("GolfManager.Model.Player", "IdplayerNavigation")
                        .WithMany()
